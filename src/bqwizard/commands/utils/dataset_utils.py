...
def create_view(
    client, source_dataset_ref: str, target_dataset_ref: str, target_table: str
):
...
def describe_dataset(client, dataset, project):
    ...
    table_data = [
        (
            ...
            t.dataset_id,
            t.table_type,
            client.get_table(f"{project}.{t.dataset_id}.{t.table_id}").num_rows,
            client.get_table(f"{project}.{t.dataset_id}.{t.table_id}").modified,
        )
